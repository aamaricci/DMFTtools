module LEGACY_DMFT_GFIO
  ...
  !DMFT INTERFACE:
  interface legacy_dmft_write_gf
...
#endif
  end interface legacy_dmft_write_gf

  !AGNOSTIC INTERFACE:
  interface legacy_write_gf
     module procedure :: dmft_gf_push_zeta
     module procedure :: dmft_gf_print_rank2
     module procedure :: dmft_gf_print_rank4
     module procedure :: dmft_gf_print_rank5
  ...
  public :: legacy_dmft_write_gf
  public :: legacy_write_gf
