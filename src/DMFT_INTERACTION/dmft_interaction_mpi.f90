subroutine dmft_interaction_setKanamori_mpi(MpiComm,Utensor,Uloc,Ust,Jh,Jx,Jp)
  implicit none
  integer                                       :: MpiComm
...
subroutine dmft_interaction_rotate_mpi(MpiComm,Utensor,rot)
  implicit none
  integer                                       :: MpiComm
  real(8),dimension(:,:,:,:,:),intent(inout)    :: Utensor  ! [Norb][Norb][Norb][Norb][2]
...
end subroutine dmft_interaction_rotate_mpi
